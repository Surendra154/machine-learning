...
% Add ones to the X datnuma matrix
%part 1
% a1 = X;
% a1 = [ones(m, 1) a1];%a1 number represents layer
% 
% z2 = Theta1 * a1';
% a2 = sigmoid(z2);
% a2 = a2';
...
% end
% 
% positiveCost = - Yk' * log(h_theta);
% negativeCost = - (1 - Yk') * log(1 - h_theta);
% 
% 
% %J = (1/m) * sum(sum(positiveCost + negativeCost));
% 
...
% y(k) -  recode the labels as vectors containing only values 0 or 1 (page 5 of ex4.pdf)
yk = zeros(num_labels, m); 
for i=1:m,
  yk(y(i),i)=1;
end
